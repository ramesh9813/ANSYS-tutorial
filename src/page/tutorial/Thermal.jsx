  ...
  return (
    <div className="tutorial-content">
      ...
      <div className="step">
        ...
        <div className="step-image">[Screenshot: ANSYS Workbench Project Schematic with Steady-State Thermal system]</div>
        <ol>
      ...
      <div className="step">
        ...
        <div className="step-image">[Screenshot: Engineering Data interface with thermal properties]</div>
      ...
      <div className="step">
        ...
        <div className="step-image">[Screenshot: ANSYS DesignModeler with heat sink geometry]</div>
        <ol>
      ...
      <div className="step">
        ...
        <div className="step-image">[Screenshot: Meshed heat sink with element display]</div>
        <ol>
      ...
      <div className="step">
        ...
        <div className="step-image">[Screenshot: Heat sink with heat flux and convection boundary conditions]</div>
        <ol>
      ...
      <div className="step">
        ...
        <div className="step-image">[Screenshot: Temperature contour plot of heat sink]</div>
        <ol>
